...
入力内容は全て学習されるので注意。「Gemini 3 Pro」というモデルが使える。
BuildタブではWebサイトのVibe Codingを試せる。
...
### Claude
https://claude.ai/
Anthropic社が開発した。くろーどと読む。「Claude Sonnet 4.5」などが使える。
最上位の「Claude Opus 4.5」は無料では使えない。

### Grok
https://grok.com
イーロン率いるxAIが開発。ツイートや画像が学習されている。
制限が緩いのが特徴。Twitter上でも利用できる。

### Gemini(gemini.google.com)
下のaistudio.google.comの下位互換。Gemini 3 Proが使えるが回数制限がきつい。がCanvasやDeep Reserchなどの機能が使える。

### Microsoft Copilot
中身はGPT-5と同じ。一応独自の機能も追加されていたりする。

## 画像生成AI
### Google AI Studio
https://aistudio.google.com
Imagen4Ultraというモデルが使える。
